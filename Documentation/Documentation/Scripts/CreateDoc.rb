...
apple_doc_command << " -x .m --ignore .m --warn-undocumented-object --warn-undocumented-member --warn-empty-description --warn-unknown-directive --warn-invalid-crossref --warn-missing-arg --no-repeat-first-par --no-keep-undocumented-objects  --no-keep-undocumented-members --prefix-merged-sections --no-search-undocumented-doc --explicit-crossref"
