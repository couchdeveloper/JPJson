...
//  
//
//  Created by Andreas Grosam on 4/18/12.
//  Copyright (c) 2012 __MyCompanyName__. All rights reserved.
//
#ifndef JSON_PARSER_INTERNAL_STRING_STORAGE2_HPP
#define JSON_PARSER_INTERNAL_STRING_STORAGE2_HPP
...
namespace json { namespace parser_internal {
    ...
    public:
        ...
        :   sa_(sa), storage_start_(0), storage_end_(0), storage_cap_(0),
            enable_partial_strings_(false)
        {
        }
        
        string_storage(SemanticActionsT& sa, std::size_t initial_storage_capacity)
        :   sa_(sa),
            enable_partial_strings_(false)
        {
