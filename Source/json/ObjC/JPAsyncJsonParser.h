...
/** 
 ...
 When downloading a resource from the net, receiving partitioned JSON content
 ...
 *Designated Initializer*
 ...
 If object `semanticActions` equals nil an instance of class `JPRepresentationGenerator`
