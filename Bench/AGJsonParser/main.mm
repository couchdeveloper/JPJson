...
static NSString* JSON_TEST_FILE = @"Test-UTF8-esc.json";
...
// -----------------------------------------------------------------------------
static void bench_AGJsonParserString1(const int N, bool printInfo = false)
{
    ...
    if (gotError) {
        ...
        NSLog(@"AGJsonParser: elapsed time for parsing: min: %.3f ms, max: %0.3f ms, avg: %0.3f ms\n", 
...
// -----------------------------------------------------------------------------
static void bench_AGJsonParser1a(const int N, bool printInfo = false)
{
    using namespace utilities;
...
// -----------------------------------------------------------------------------
static void bench_AGJsonParser1b(const int N, bool printInfo = false)
{
    using namespace utilities;
...
//  The input encoding will be detected automatically.
// -----------------------------------------------------------------------------
static void bench_AGJsonParser1x(const int N, bool printInfo = false)
{
    using namespace utilities;
...
static void bench_AGJsonParser1d(const int N, bool printInfo = false)
{
    using namespace utilities;
    ...
    if (gotError) {
        ...
        NSLog(@"AGJsonParser: elapsed time for parsing %d documents: %.3f s\n\n", N, t.seconds());
    }
}


static void bench_AGAsyncJsonParser(const int N, bool printInfo = false)
{
    using namespace utilities;
    ...
    printf("Asynchronous Parser, using a NSData with UTF-8 \n"
           "content as input\n"
           "Timing includes destruction of JSON objects, the \n"
           "semantic actions object is kept alive, giving it\n"
           "and advantage, since key strings are cached.\n"
...
//  The input encoding shall be set explicitly
// -----------------------------------------------------------------------------
static void bench_AGJsonParser2(const int N, bool printInfo = false)
{
    using namespace utilities;
...
static void bench_JSONKitString1(const int N, bool printInfo = false)
{
    using namespace utilities;
    ...
    if (gotError) {
        ...
        NSLog(@"JSONKit: elapsed time for parsing: min: %.3f ms, max: %0.3f ms, avg: %0.3f ms\n", 
              te.min()*1e3, te.max()*1e3, te.avg()*1e3);
    }
}
...
static void bench_JSONKit1(const int N, bool printInfo = false)
{
    using namespace utilities;
...
static void bench_JSONKit2(const int N, bool printInfo = false)
{
    using namespace utilities;
    ...
    if (gotError) {
        ...
        NSLog(@"JSONKit: elapsed time for parsing %d documents: %.3f s\n\n", N, t.seconds());
    }
}
...
static void bench_NSJSONSerialization1(const int N, bool printInfo = false)
{
    using namespace utilities;
    ...
    if (gotError) {
        ...
        NSLog(@"NSJSONSerialization: elapsed time for parsing: min: %.3f ms, max: %0.3f ms, avg: %0.3f ms\n", 
              te.min()*1e3, te.max()*1e3, te.avg()*1e3);
    }
}

static void bench_NSJSONSerialization2(const int N, bool printInfo = false)
{
    using namespace utilities;
    ...
    if (gotError) {
        ...
        NSLog(@"NSJSONSerialization: elapsed time for parsing %d documents: %.3f s\n\n", N, t.seconds());
    }
}
