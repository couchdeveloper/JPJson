...
namespace {
    ...
    TEST_F(JsonObjectTest, ExposedTypes) {        
        ...
        typedef boost::mpl::apply<Value::policies_t::string_imp_tt, Value::string_encoding_t>::type string_t;
    ...
    TEST_F(JsonObjectTest, testMoveSemanticsForObject)
    {
        ...
        EXPECT_EQ("abcd", o2["key0"]);
        EXPECT_EQ(1.0, o2["key1"]);
        EXPECT_EQ(false, o2["key2"]);
        EXPECT_EQ(null, o2["key3"]);
    }
