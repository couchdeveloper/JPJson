...
- (void) jsonRequestDidStartConnection:(DemoJSONController *)controller
{
    self.isActive = YES;
    NSLog(@"jsonRequestDidStartConnection:");
}

- (void) jsonRequestDidFinishConnection:(DemoJSONController *)controller
{
    NSLog(@"jsonRequestDidFinishConnection:");
}

- (void) jsonRequestDidStartParsingJSON:(DemoJSONController *)controller
{
    NSLog(@"jsonRequestDidStartParsingJSON:");
}

- (void) jsonRequest:(DemoJSONController *)controller didCreateJSONRepresentation:(id)json
{
...
- (void) jsonRequestFinishedParsing:(DemoJSONController*)controller
{
...
- (void) jsonRequest:(DemoJSONController *)controller didFailWithError:(NSError *)error
{
...
- (void) jsonRequest:(DemoJSONController *)controller 
